...
async function main() {
  ...
  const imgs = {
    logo: getImageDataUri('Office.jpeg'),
    signage: getImageDataUri('HomePage.jpeg'),
    hero: getImageDataUri('HomePage.jpeg'),
    hero2: getImageDataUri('HomePage1.jpeg'),

    kotaBlue1: getImageDataUri('Kota Blue Stone.jpeg'),
    kotaBlue2: getImageDataUri('Gallery2.jpeg'),
    kotaBlue3: getImageDataUri('Gallery3.jpeg'),

    kotaBrown1: getImageDataUri('Kota Brown Stone.jpeg'),
    kotaBrown2: getImageDataUri('Gallery6.jpeg'),
    kotaBrown3: getImageDataUri('Gallery22.jpeg'),

    mandana1: getImageDataUri('Mandana Red Stone.jpeg'),
    mandana2: getImageDataUri('Gallery7.jpeg'),
    mandana3: getImageDataUri('Card.jpeg'),

    slabs1: getImageDataUri('Large Format Slabs.jpeg'),
    slabs2: getImageDataUri('Gallery1.jpeg'),
    slabs3: getImageDataUri('Gallery12.jpeg'),

    stairs1: getImageDataUri('Stairs.jpeg'),
    stairs2: getImageDataUri('Gallery14.jpeg'),
    stairs3: getImageDataUri('Card1.jpeg'),

    cladding1: getImageDataUri('Wall Cladding.jpeg'),
    cladding2: getImageDataUri('Gallery13.jpeg'),
    cladding3: getImageDataUri('Gallery21.jpeg'),

    garden1: getImageDataUri('Garden.jpeg'),
    garden2: getImageDataUri('Gallery15.jpeg'),
    garden3: getImageDataUri('Types.jpeg'),
    ...
    factoryYard1: getImageDataUri('Gallery11.jpeg'),
    factoryYard2: getImageDataUri('Gallery20.jpeg'),
    stockYard1: getImageDataUri('Gallery24.jpeg'),

    qualityDoc: getImageDataUri('Quality.jpeg'),
    qualityImg: getImageDataUri('Quality.jpeg'),
    packingDoc: getImageDataUri('Packing.jpeg'),
    packingImg: getImageDataUri('Packing.jpeg'),
    loading1: getImageDataUri('workers-loading-1.jpeg'),
    deliveryDoc: getImageDataUri('Delivery.jpeg'),
    deliveryImg: getImageDataUri('Delivery.jpeg'),

    proj1: getImageDataUri('Gallery26.jpeg'),
    proj2: getImageDataUri('Gallery27.jpeg'),
    proj3: getImageDataUri('Gallery28.jpeg'),
    proj4: getImageDataUri('Gallery29.jpeg'),
    proj5: getImageDataUri('Gallery30.jpeg'),
    proj6: getImageDataUri('Gallery31.jpeg'),
  };
